...
public class SkiGame extends PApplet {
...
public void timer()  // method to keep time for game 
{
  ...
  fill(0xffdb150a);  // method to display time on top of screen
  textAlign(CENTER);
  if (min >0)
  {
...
public String playerName()  // method to request players name and return it to method as string 
{
...
public int chooseLevel()  // method to select difficulty by speed, called and returned value inside welcome method as integer
{
...
public void boundryCheck() // check boundaries, reverse direction at boundries
{
  if  (skiX<14)
  {   
    directionX=1;
...
public void crash(int treeYOrigionalIn[], int tree1XOrigionalIn[], int tree2XOrigionalIn[] )  // checks about replay and sets tree values to origionals from array.
{
  if (min>0)
  {
...
public void tree(int treeX,int treeY)  //  tree design
{
  ...
  public void settings() {  size(730,800); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SkiGame" };
    if (passedArgs != null) {
