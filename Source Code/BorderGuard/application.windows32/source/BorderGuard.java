...
public class BorderGuard extends PApplet {
...
int randomCountry=PApplet.parseInt (random(0, 3));
int randomPassport=PApplet.parseInt(random(0, 3));
//speed of Ryu
float ryuSpeed=1;
//Ryu starting coord
float ryuX=1250;
...
public int timeMap(int timeMaps){
  int result;
...
//tree draw method
public void tree(float xTree, float yTree, float treeSize, float treeRcolor, float treeGcolor, float treeBcolor) {
  stroke(0);
  strokeWeight(3);
  fill(139, 69, 19);
...
public void Ryu(int xRyu, int yRyu, int colorR) {
  fill(colorR);
...
//Ryu draw method
public void Ryu(float xRyu, float yRyu) {
  fill(0);//body color
...
//stars draw method
public void stars(int xStar, int yStar) {
  int randomOpacity=PApplet.parseInt (random(200, 255));
...
//moon draw method
public void moon(float xMoon, float yMoon) {
  fill(240, 240, 240 );
  stroke(240, 240, 240 );
  strokeWeight(2);
...
public void rainDrop(float xRain, float yRain) {
  float randomOpacity;
  float randomWeight;
...
//country 3 user input
 ...
 timeMap=timeMap(0);
  ...
  if (timeMap==3) {  
    ...
    tree(1000, 500, 0.5f, 0, 80, 0);
    tree(1100, 480, 0.5f, 0, 80, 0);
    tree(1150, 500, 0.5f, 0, 80, 0);
    //ryu's house front
    fill(51, 25, 0);
    strokeWeight(2);
    stroke(0);
    ...
    tree(600, 500, 0.25f, 0, 100, 0);
    tree(620, 510, 0.25f, 0, 60, 0);
    tree(650, 520, 0.35f, 0, 70, 0);
    tree(670, 550, 0.45f, 0, 120, 0);
    tree(450, 610, 1.6f, 0, 110, 0);
    tree(590, 560, 1.1f, 0, 100, 0);
    tree(520, 650, 1.4f, 0, 100, 0);
    tree(360, 630, 2, 0, 120, 0);
    tree(300, 640, 2, 0, 60, 0);
    tree(900, 500, 0.25f, 0, 100, 0);
    tree(850, 510, 0.5f, 0, 100, 0);
    tree(870, 520, 0.5f, 0, 100, 0);
    tree(800, 560, 1.1f, 0, 100, 0);
  ...
  if (timeMap==4) {
    ...
    tree(150, 500, 1.5f, 0, 80, 0);
    tree(410, 500, 2, 0, 160, 0);
    tree(480, 550, 2.5f, 0, 120, 0);
    tree(1200, 550, 2.5f, 0, 120, 0);
...
//blinking Ryu
   ...
   if (smallRyuHappy==400) {
    ...
    if ((smallRyuHappy < 0)||(smallRyuHappy>1230)) {   
      smallRyuX=1200;
      smallRyuXSpeed=2;
      randomCountry=PApplet.parseInt (random(0, 3));
      randomPassport=PApplet.parseInt(random(0, 3));
      smallRyuHappy=740;
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "BorderGuard" };
    if (passedArgs != null) {
